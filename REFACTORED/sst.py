...
myEOF.plotEigenvalueErrorBars(eigenvalue_list, 'SST_sampling_eigenvalue_errorbars_ev:2-10', ignore_first_ev=True)
myEOF.plotEigenvalueErrorBars(eigenvalue_list, 'SST_sampling_eigenvalue_errorbars_ev:1-10')
